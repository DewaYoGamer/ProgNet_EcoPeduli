    ...
    <div class="flex flex-col">
                    ...
                    <div class="flex flex-row">
                        ...
                        <div class="px-10 self-stretch text-2xl flex">
                            <p class="font-normal text-justify">
                                ...
                                <br>
                                <span class="mt-4 mb-4 inline-block cursor-pointer text-primary text-2xl font-semibold hover:underline" id="topik3-btn">3. Bagaimana Sampah yang Menumpuk Dapat Menyebabkan Banjir?</span>
                                <br>
        ...
        <div id="topik1-modal" class="fixed inset-0 hidden z-50 items-center justify-center bg-black bg-opacity-50">
            <div class="bg-white rounded-lg w-[90rem] p-8">
                <h2 class="text-4xl font-bold mb-4">1. Apa Dampak Buruk Sampah Terhadap Kesehatan dan Lingkungan?</h2>
                <p class="text-2xl">
        ...
        <div id="topik2-modal" class="fixed inset-0 hidden z-50 items-center justify-center bg-black bg-opacity-50">
            <div class="bg-white rounded-lg w-[90rem] p-8">
                <h2 class="text-4xl font-bold mb-4">2. Apa Dampak Sampah Plastik terhadap Ekosistem Laut?</h2>
                <p class="text-2xl">
        ...
        <div id="topik4-modal" class="fixed inset-0 hidden z-50 items-center justify-center bg-black bg-opacity-50">
            <div class="bg-white rounded-lg w-[90rem] p-8">
                <h2 class="text-4xl font-bold mb-4">4. Apa Bahaya Limbah Elektronik bagi Kesehatan dan Lingkungan?</h2>
                <p class="text-2xl">
